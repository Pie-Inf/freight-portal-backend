...
import com.freightportal.model.User;
...
public class MongoConfig extends AbstractMongoClientConfiguration {
    ...
    protected void configureConverters(MongoCustomConversions.MongoConverterConfigurationAdapter adapter) {
        adapter.registerConverter(new GeoJsonModule());
    }
    ...
    private void createIndexes() {
        ...
        loadIndexOps.ensureIndex(
                new org.springframework.data.mongodb.core.index.CompoundIndexDefinition(
                        new org.springframework.data.mongodb.core.index.Index()
                                ...
                                .on("pickupDate", org.springframework.data.domain.Sort.Direction.ASC)
        ...
        fleetIndexOps.ensureIndex(
                new org.springframework.data.mongodb.core.index.CompoundIndexDefinition(
                        new org.springframework.data.mongodb.core.index.Index()
                                .on("status", org.springframework.data.domain.Sort.Direction.ASC)
                                .on("availableFrom", org.springframework.data.domain.Sort.Direction.ASC)
                                .on("vehicle.type", org.springframework.data.domain.Sort.Direction.ASC)
                )
        );
